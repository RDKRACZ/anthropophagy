...
public class PigluttonEntityModel<T extends LivingEntity> extends EntityModel<T> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		chest.addChild("rightPec_r1", ModelPartBuilder.create().uv(41, 38).cuboid(-4.5F, -7.0F, -2.0F, 7.0F, 7.0F, 4.0F), ModelTransform.of(-2.0F, -2.4021F, -4.8154F, -0.2182F, 0.1047F, -0.0873F));
		...
		chest.addChild("bipedRightArm", ModelPartBuilder.create().uv(70, 0).cuboid(-3.0F, -3.0F, -1.0F, 4.0F, 20.0F, 5.0F).uv(69, 26).mirrored(true).cuboid(-3.5F, -4.0F, -1.5F, 4.0F, 7.0F, 6.0F), ModelTransform.of(-6.0F, -3.4021F, -2.8154F, -1.7017F, 0.0F, 0.0524F));
		ModelPartData bipedRightLeg = body.addChild("bipedRightLeg", ModelPartBuilder.create().uv(89, 0).cuboid(-3.0F, 1.1F, -2.0F, 6.0F, 12.0F, 6.0F), ModelTransform.of(-2.6F, -0.0263F, 2.3801F, -1.2217F, 0.1222F, 0.0698F));
		ModelPartData rightLeg02 = bipedRightLeg.addChild("rightLeg02", ModelPartBuilder.create().uv(95, 19).cuboid(-2.0F, -0.5F, -0.1F, 4.0F, 9.0F, 4.0F), ModelTransform.of(-0.1388F, 8.7572F, 3.6969F, 0.0F, 0.0F, 0.0F));
		...
		rightTrotter.addChild("rTrotterClaw01", ModelPartBuilder.create().uv(115, 0).cuboid(-1.0F, -1.3F, -2.0F, 2.0F, 2.0F, 3.0F), ModelTransform.of(-1.1F, 1.5F, -1.1F, 0.6981F, 0.1047F, 0.0349F));
		...
		leftTrotter.addChild("lTrotterClaw02", ModelPartBuilder.create().uv(115, 0).cuboid(-1.0F, -1.3F, -2.0F, 2.0F, 2.0F, 3.0F), ModelTransform.of(-1.0F, 1.5F, -1.1F, 0.6981F, 0.1047F, 0.0349F));
